...
export default abstract class Database {
    ...
    public abstract saveStoryElement(userID: string, campaignID: string, storyElementID: string, type: string, name: string, description: string, associations: string[]): Promise<void>;
    public abstract getStoryElements(userID: string, campaignID: string): Promise<{id: string, type: string, name: string, description: string, associations: string[]}[]>;
